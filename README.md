...
3. Det fungerade inte som vi hade hoppats, det fanns många delar i koden som inte fungerade för oss och vi va inte helt säkra 4. på att våran koppling stämde.
5. Vi avvaktade att testa med resistorn tillsvidare.
...
Tisdag 16e: Desifna sidan efter användaren.
